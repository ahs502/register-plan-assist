...
const PreplanPage: FC = () => {
  ...
  const [flightRequirments, setFlightRequirments] = useState<FlightRequirement[]>();
            ...
            <Route
              ...
              render={() => (
                <FlightRequirementListPage
                  ...
                  onAddFlightRequirement={() => setFlightRequirementModalModel({ ...flightRequirementModalModel, open: true, weekly: true /*TODO*/ })}
